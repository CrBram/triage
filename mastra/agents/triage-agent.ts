...
/**
 * Model in Mastra's `provider/model` router format. Credentials are read from
 * the provider's env var (OPENAI_API_KEY, ANTHROPIC_API_KEY, GOOGLE_API_KEY...).
 */
export const TRIAGE_MODEL =
  process.env.TRIAGE_MODEL ?? "google/gemini-3.6-flash";
